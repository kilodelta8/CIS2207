...
/** @date 01/09/2023 */
/** @version 0.0.5 */
/** @target Windows 10.0 (Latest Installed Version */
/* CIS 2207.501
...
int main() {
	...
	do {
		std::cout << "Enter the number of guesses you wish to provide at a time: \n";
		std::cin >> numGuesses;
		std::cout << "Enter the maximum range of numbers to geuss from 1 to (x): \n";
		std::cin >> maxRange;
